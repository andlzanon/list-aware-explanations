...
class RecommenderSystem:
    ...
    def run_experiment(self, k: int, expl_results: dict, expr_file: str, n_users=0, rows=3, cols=2, save_results=False,
        ...
        metrics_value = self.__evaluate(predictions=predictions, test_recs=test_df, k=k, verbose=verbose)
    ...
    def __evaluate(self, predictions: pd.DataFrame, test_recs: pd.DataFrame, k: int, verbose=True) -> dict:
        """
        ...
        :param k: top k recommendations to extract metrics
